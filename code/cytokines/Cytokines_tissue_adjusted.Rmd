...
Exp1_tissue_weight
ggsave('exports/cytokines/Exp1-weights-of-tissue.png',Exp1_tissue_weight)
```
...
add_p() %>% 
  ...
  cols_width(label ~ px(80),
             ...
             stat_4 ~ px(140)) 
Exp1_tbl1 %>%
  gtsave(path = "exports/cytokines/", filename = "Exp1-tissue-adjusted.png", vwidth = 760, vheight = 450)
...
ggsave('exports/cytokines/Exp1-tissue-adjusted-plot.png',Exp1_plot_all_cytokines)
```
...
ggsave('exports/cytokines/Exp2-weights-of-tissue.png',Exp2_tissue_weight)
...
ggsave('exports/cytokines/Exp2-tissue-adjusted-plot.png',Exp2_plot_all_cytokines)
```
...
ggsave('exports/cytokines/Exp3-weights-of-tissue.png',Exp3_tissue_weight)
...
ggsave('exports/cytokines/Exp3-tissue-adjusted-plot.png',Exp3_plot_all_cytokines)
```
...
ggsave('exports/cytokines/Exp4-weights-of-tissue.png',Exp4_tissue_weight)
...
ggsave('exports/cytokines/Exp4-tissue-adjusted-plot.png',Exp4_plot_all_cytokines)
```
