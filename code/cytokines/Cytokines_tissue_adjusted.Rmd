---
title: "Cytokine analysis script - all rounds - adjusted for tissue weight"
author: "Kaare"
...
# All experiments - tissue weight stats

```{r}

cytokines_long %>%       
  filter(exp_number %in% c("1","3")) %>% 
  group_by(exp_number) %>% 
  kruskal_test(tissue_weight_mg ~ type_of_feed)

#|exp_number |Effect       | DFn| DFd|       F|     p|p<.05 |   ges|
#|:----------|:------------|---:|---:|-------:|-----:|:-----|-----:|
#|1          |type_of_feed |   1| 298|   0.816| 0.367|      | 0.003|
#|3          |type_of_feed |   1| 378| 373.425| 0.000|*     | 0.497|
#|4          |type_of_feed |   1| 258|   9.863| 0.002|*     | 0.037|
...
Exp1_tissue_weight
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp1-weights-of-tissue.png',Exp1_tissue_weight)
```
...
Exp1_tbl1
Exp1_tbl1 %>%
  gtsave(path = "exports/cytokines/", filename = "Exp1-tissue-adjusted-table.png")
...
ggsave(width = 170, height = 120, units = "mm", 'exports/cytokines/Exp1-tissue-adjusted-plot.png',Exp1_plot_all_cytokines)
```
...
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp2-weights-of-tissue.png',Exp2_tissue_weight)
...
Exp2_tbl1
Exp2_tbl1 %>%
  gtsave(path = "exports/cytokines/", filename = "Exp2-tissue-adjusted-table.png")
...
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp2-tissue-adjusted-plot.png',Exp2_plot_all_cytokines)
```
...
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp3-weights-of-tissue.png',Exp3_tissue_weight)
...
Exp3_tbl1
Exp3_tbl1 %>%
  gtsave(path = "exports/cytokines/", filename = "Exp3-tissue-adjusted-table.png")
```
...
ggsave(width = 200, height = 120, units = "mm",'exports/cytokines/Exp3-tissue-adjusted-plot.png',Exp3_plot_all_cytokines)
```
...
cytokines_long %>%       
  ...
  summarize(mean = mean(tissue_weight_mg),
            ...
            median = median(tissue_weight_mg),
            iqr = IQR(tissue_weight_mg))

  anova_test(tissue_weight_mg ~ type_of_feed)
...
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp4-weights-of-tissue.png',Exp4_tissue_weight)
...
Exp4_tbl1
Exp4_tbl1 %>%
  gtsave(path = "exports/cytokines/", filename = "Exp4-tissue-adjusted-table.png")
```
...
ggsave(width = 170, height = 120, units = "mm",'exports/cytokines/Exp4-tissue-adjusted-plot.png',Exp4_plot_all_cytokines)
```
