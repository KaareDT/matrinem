...
tbl1_gt
tbl1_gt %>% 
  gtsave("../../Results/Round 3/FITC table round 3 TEST.png", expand = 50) #use .tex for latex files
```
...
all_fitc_patch_log10 <- plot_all_fitc_log10 + plot_annotation (
  ...
  #tag_levels = 'A',
  caption = 'CON = Water, BF = Breast-Feeding, GENTA = Gentamicin,  VANCO = Vancomycin,  \n
  Overall difference= Anova',
  theme = theme(plot.title = element_text(hjust = 0.5, size=14, face="bold"),
                plot.subtitle = element_text(hjust = 0.5, face = "bold.italic"),
                plot.caption = element_text(hjust = 0.5, size=7,face = "bold")))
  
all_fitc_patch_log10
ggsave('../../Results/Round 3/FITC boxplot log 10.png',all_fitc_patch)
```
