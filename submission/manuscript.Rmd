 ...
 **(The problem here is that formula is the only thing with an effect. A breastfed control only shows the effect of the formula)**
...
*Cytokine expression*
- We found significant differences in concentrations of TNFa in Exp 4, with greater level in the FVT-treated group (XXX), compared to both VANCO-BF and VANCO-FF (SM) (XXX and XXXX respectively). 
...
*Gene expression*
- qPCR analyzis of intestinal samples found statistically significant differences in the level of XXXSIGNIFICANT_GENESXXX expression between groups with the delta-delta method (reformulate).
- However, a difference in expression of the reference gene between the FVT and breastfed control was observed. this difference was statistically significant, invalidating the assumption of *equal baseline expression.*(reformulate)
- Comparing the groups on the basis of (SOMEHTING ELSE THAN DELTA DELTA) found a `r fold_increase_reg3g`-fold increased expression of the `r REG3G` gene in the FVT groups. 
