...
<!--# Run scripts for plots on another file and save plots on img folder. Then use include_graphics to include plots where relevant -->
...
-   Formula-feeding was performed as per METHODS AND MATERIALs.
    In Exp-1 we administered 0.08 ml formula for pups \>2g, and 0.06 for pups ≤ 2g every 3 hours throughout the entire study.
...
-   No signs of intestinal inflammation were evident from the visual inspection of intestines during sampling.
    Our subjective observation of the intestines were small degrees of bloating in formula-fed pups.

**Cytokines**

`r nrow(cytokines_1)` samples were available for analysis of the proinflammatory cytokines `r names_of_cytokines`.
Concentrations were measured in 1-cm sections of proximal/distal ileum tissue using MSD Mesoscale Kits.
Statistically significant changes in the expression of `r names_of_cytokines`.
- Directionality of change varied, with alternating over- and under-expression of various cytokines.
As can be seen in [*Cytokine plot of signif results* ] pups tended to group based on feeding-scheme, with both formula-fed groups being either suppressed or over-expressed together, compared with breastfed groups, irrespective of antibiotics treatment.
